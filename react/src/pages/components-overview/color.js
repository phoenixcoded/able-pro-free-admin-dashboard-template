                    ...
                    <Grid item xs={12} sm={6}>
                        <MainCard title="Primary Color">
                            <Stack>
                                ...
                                <ColorBox
                                    bgcolor="primary.400"
                                    data={{ label: 'Blue-5', color: `${theme.palette.primary[400]}` }}
                                    title="primary[400]"
                                />
                                <ColorBox
                                ...
                                <ColorBox
                                    ...
                                    data={{ label: 'Blue-7', color: `${theme.palette.primary.dark}` }}
                                    title="primary.dark"
                                />
                                <ColorBox
                                    bgcolor="primary.700"
                                ...
                                <ColorBox
                                    bgcolor="primary.900"
                                    data={{ label: 'Blue-10', color: `${theme.palette.primary[900]}` }}
                                    title="primary.900"
                                />
                            </Stack>
                        </MainCard>
                    ...
                    <Grid item xs={12} sm={6} md={4}>
                        <MainCard title="Error Color">
                            <Stack>
                                ...
                                <ColorBox
                                    bgcolor="error.main"
                                    data={{ label: 'Red-6', color: `${theme.palette.error.main}` }}
                                    title="error.main"
                                    main
                                />
                                <ColorBox
