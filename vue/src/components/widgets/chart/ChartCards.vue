        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-body-large mb-0">All Earnings</h6>
                ...
                <v-menu width="150" location="start">
                  ...
                  <v-list elevation="24" aria-label="menu" aria-busy="true" class="pa-3" rounded="md">
                    <v-list-item
                      ...
                      :value="index"
                    >
                      <v-list-item-title class="text-headline-small text-lightText">{{ item }}</v-list-item-title>
                    </v-list-item>
                  </v-list>
                </v-menu>
              </template>
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5>$3200</h5>
                <p class="text-body-medium text-primary mb-0">
        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-body-large mb-0">Page Views</h6>
              <template v-slot:append>
                <v-menu width="150" location="start">
                  <template v-slot:activator="{ props }">
                    <v-btn icon color="secondary" aria-label="menu" variant="text" rounded="md" size="small" v-bind="props">
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5>290+</h5>
                <p class="text-body-medium text-warning mb-0">
        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-body-large mb-0">Total task</h6>
              <template v-slot:append>
                <v-menu width="150" location="start">
                  <template v-slot:activator="{ props }">
                    <v-btn icon color="secondary" aria-label="menu" variant="text" rounded="md" size="small" v-bind="props">
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5>1468</h5>
                <p class="text-body-medium text-success mb-0">
                  <SvgSprite name="custom-rise-outline" style="width: 16px; height: 16px; transform: rotate(45deg)" />
                  30.6%
                </p>
              </v-col>
        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-body-large mb-0">Download</h6>
              <template v-slot:append>
                <v-menu width="150" location="start">
                  <template v-slot:activator="{ props }">
                    <v-btn icon color="secondary" aria-label="menu" variant="text" rounded="md" size="small" v-bind="props">
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5>$300</h5>
                <p class="text-body-medium text-error mb-0">
